...
<Link className="inline-block mt-4 text-primary font-label-md hover:underline" to="/">Get Directions →</Link>
</div>
<div className="bg-surface-container p-8 border border-outline-variant rounded-lg group hover:border-primary transition-colors">
<div className="w-12 h-12 bg-primary flex items-center justify-center rounded mb-6 text-on-primary">
<Phone />
...
<Link className="w-10 h-10 border border-on-primary/30 flex items-center justify-center rounded hover:bg-white hover:text-primary transition-all" to="/">
